...
<template>
  ...
  >
    ...
    <div class="h-[76px] sm:h-[80px] flex items-center justify-between px-3 sm:px-3.5 border-b border-slate-800/80 shrink-0">
      ...
      <button
        type="button"
        class="hidden lg:flex w-7 h-7 rounded-lg items-center justify-center text-slate-400 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer shrink-0 ms-1"
